      ...
      <div className="w-full flex justify-center md:w-7/12 ">
        <div className="px-4">
          ...
          <h1 className="my-2 text-2xl md:text-4xl font-bold">
            I’m <span className="bg-gradient-to-r from-[#5f93e7] to-blue-400 bg-clip-text text-transparent">Mohamed Ahmed</span>
          </h1>
          ...
          <div className="mt-8 flex gap-4 justify-center md:justify-start">
            <button className="bg-white rounded-full text-[#162d71] py-2 px-6 font-semibold hover:bg-[#5f93e7] hover:text-white transition">
              <a href="#projects">View My Work</a>
            </button>
            <button className="bg-transparent rounded-full border border-white py-2 px-6 font-semibold hover:bg-[#5f93e7] hover:border-[#5f93e7] transition">
